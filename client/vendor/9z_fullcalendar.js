...
var Grid = fc.Grid = RowRenderer.extend({
  ...
  headCellHtml: function(cell) {
    var view = this.view;
    var date = cell.start;
    var shiftId = TimeToShifts['' + date.toDate().getTime()];
...
Grid.mixin({
  ...
  getEventTimeText: function(range, formatStr, displayEnd) {
    ...
    // console.log(".....getEventTimeText....range...", range, formatStr)
    if (this.displayEventTime && range.start.hasTime()) {
      if (displayEnd && range.end) {
        ...
        // console.log("............2", range.start.format(formatStr));
...
TimeGrid.mixin({
  ...
  fgSegHtml: function(seg, disableResizing) {
    var view = this.view;
    var event = seg.event;
    // console.log("------fgSegHtml----event", event)
    ...
    if (view.isMultiDayEvent(event)) { // if the event appears to span more than one day...
      ...
      // console.log("---startTimeText-----", startTimeText, fullTimeText)
    }
    return '<a class="' + classes.join(' ') + '"' +
      (event.url ?
        ' href="' + htmlEscape(event.url) + '"' :
...
var View = fc.View = Class.extend({
  ...
  computeTitle: function() {
    if(this.name == "agendaWeek") { 
      return moment(this.intervalStart).format("DD MMM YYYY");
    } else {
