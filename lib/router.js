...
Router.route('/sales/forecast/cafe', {
  ...
  template: "weeklyForecastListView",
  waitOn: function() {
    return subs.subscribe("menuList", null, null);
  },
  data: function() {
...
Router.route('/sales/forecast/cafe/edit', {
  name: "cafeSalesForecastEdit",
  path: '/sales/forecast/cafe/edit',
  template: "cafeSalesForecastEditView",
  waitOn: function() {
    return subs.subscribe("menuList", null, null);
  },
  data: function() {
...
Router.route('/sales/calibration/:week', {
  name: "salesCalibration",
  path: '/sales/calibration/:week',
  template: "salesCalibrationView",
  waitOn: function() {
    var cursor = [];
    cursor.push(subs.subscribe("menuList", "all", "active"));
