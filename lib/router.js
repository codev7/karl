...
Router.route('/menuItem/:_id', {
  ...
  waitOn: function() {
    return Meteor.subscribe("menuItem", this.params._id);
  },
  data: function() {
    Session.set("thisMenuItem", this.params._id);
  }
...
Router.route('/jobItems', {
  ...
  waitOn: function() {
    return Meteor.subscribe("jobItems");
  },
  data: function() {
...
Router.route('/ingredients', {
  ...
  waitOn: function() {
    var ingredientsSubs = Meteor.subscribe("ingredients");
    return ingredientsSubs;
  }
});
