...
// ---------------------SALES ROUTES
Router.route('/sales/ranged', {
  name: "salesRanged",
  path: '/sales/ranged',
  template: "salesRangedListedView",
  waitOn: function() {
    subs.clear();
  },
  data: function() {
...
Router.route('/sales/:date', {
  name: "actualSales",
  path: '/sales/:date',
  template: "actualSalesListView",
  waitOn: function() {
    var cursors = [];
    cursors.push(subs.subscribe("salesOnDate", this.params.date));
...
Router.route('/sales/forecast/:date', {
  name: "salesForecast",
  path: '/sales/forecast/:date',
  template: "salesForecastView",
  waitOn: function() {
