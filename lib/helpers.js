...
createNotificationText = function(type, id, oldItemData, newInfo) {
  var list = [];
  if(type == "job") {
    console.log("..........id", id);
    console.log(".....old", oldItemData);
    console.log(".....newInfo", newInfo);
    if(oldItemData) {
      for(var key in newInfo) {
        var subtitle = key.substring(0, 1).toUpperCase() + key.substring(1, 50);
        var str = "";
        console.log("............", key);
        if(key == "name" || key == "portions" || key == "shelfLife" || key == "activeTime" || key == "wagePerHour") {
          str = "" + subtitle + " changed from '" + oldItemData[key] + "'' to '" + newInfo[key] + "'";
          console.log(".........................str...", str);
          list.push(str);
        }
        // $(str).appendTo($(list));
